 ...
 */
public class ParametrizedJunitReporter implements Reporter, Formatter {
    ...
    private ParametrizedExecutionUnitRunner executionUnitRunner;
    private RunNotifier runNotifier;
    EachTestNotifier executionUnitNotifier;
    private boolean ignoredStep;
    private boolean inScenarioLifeCycle;

    public ParametrizedJunitReporter(Reporter reporter, Formatter formatter, boolean strict) {
        this.reporter = reporter;
        this.formatter = formatter;
        this.strict = strict;
    }

    public void startExecutionUnit(ParametrizedExecutionUnitRunner executionUnitRunner, RunNotifier runNotifier) {
