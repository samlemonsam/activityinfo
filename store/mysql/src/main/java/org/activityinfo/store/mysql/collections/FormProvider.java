...
/**
 * Internal interface for the MySqlCatalog, which helps to delegate FormAccessor implementation 
...
public interface FormProvider {
    ...
    FormAccessor openForm(QueryExecutor executor, ResourceId formId) throws SQLException;

    Optional<ResourceId> lookupForm(QueryExecutor executor, ResourceId recordId) throws SQLException;
    
    Map<ResourceId, FormAccessor> openForms(QueryExecutor executor, Set<ResourceId> formIds) throws SQLException;
}
