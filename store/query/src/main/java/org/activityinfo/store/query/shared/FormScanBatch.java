...
import org.activityinfo.store.query.shared.plan.ReferencePlanNode;
...
public class FormScanBatch {
     ...
     */
    public Slot<ColumnView> addRecordId(FilterLevel filterLevel, ResourceId formId) {
        return filter(filterLevel, formId, getTable(formId).addRecordId());
    }
    ...
    private Slot<ColumnView> addParentColumn(FilterLevel filterLevel, ResourceId formId) {
        return addLeafColumn(filterLevel, formId, new SymbolExpr("@parent"));
    }

    public ReferenceJoin addJoinLink(FilterLevel filterLevel, ReferencePlanNode node) {
    ...
    private Slot<PrimaryKeyMap> addPrimaryKey(FilterLevel filterLevel, ResourceId formId) {
        Slot<ColumnView> filteredIdSlot = addRecordId(filterLevel, formId);
    ...
    private Slot<ForeignKey> addForeignKey(FilterLevel filterLevel, ReferencePlanNode node) {
    ...
    public Slot<ColumnView> addLeafColumn(FilterLevel filterLevel, ResourceId formId, ExprNode fieldExpr) {
