...
public class JoinLink {
    ...
    private static final Logger LOGGER = Logger.getLogger(JoinLink.class.getName());
    ...
    public JoinLink(Slot<ForeignKeyMap> foreignKey, Slot<PrimaryKeyMap> primaryKeyMap, String debugName) {
