...
public class DownSynchronizer implements AsyncCommand {
    ...
    public DownSynchronizer(EventBus eventBus, @Remote Dispatcher remoteDispatcher, SqlDatabase conn) {
        ...
        this.conn = conn;
        this.dispatch = remoteDispatcher;
    ...
    public void execute(AsyncCallback<Void> callback) {
        ...
        fireStatusEvent(I18N.CONSTANTS.requestingSyncRegions(), 0);
        running = true;
        stats.onStart();
        retrieveSyncRegions();
    }
    ...
    private void onSynchronizationComplete() {
        stats.onFinished();
        setLastUpdateTime();
        fireStatusEvent(I18N.CONSTANTS.synchronizationComplete(), 100);
    ...
    private void doUpdate(final SyncRegion region, String localVersion) {
        ...
        fireStatusEvent(I18N.CONSTANTS.downSyncProgress(), regionIt.percentComplete());
