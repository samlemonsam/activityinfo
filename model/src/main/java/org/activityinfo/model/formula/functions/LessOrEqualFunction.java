 ...
 */
public class LessOrEqualFunction extends ComparisonOperator {

    public static final LessOrEqualFunction INSTANCE = new LessOrEqualFunction();

    public LessOrEqualFunction() {
        super("<=");
    }
